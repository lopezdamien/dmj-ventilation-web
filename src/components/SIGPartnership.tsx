...
export default function SIGPartnership() {
    return (
        <section className="py-32 bg-[#1E5B3A] text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 md:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row gap-20 items-start">
                    ...
                    <div className="max-w-3xl lg:w-2/3">
                        <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/10 rounded-full mb-8 border border-white/5">
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold mb-10 leading-tight tracking-tight">
                            Partenaire des SIG – Ensemble pour une ventilation plus économe.
                        </h2>

                        <div className="space-y-8 text-lg font-light leading-relaxed text-gray-200">
                            <p>
